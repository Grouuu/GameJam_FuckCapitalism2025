...
{
	public class BuildingsManager : IManager
	{
		private readonly BuildingsManagerSettings _settings;
		private BuildingData[] _buildings;

		public BuildingsManager (BuildingsManagerSettings settings)
		{
			_settings = settings;
		}
		...
		public void UpdateSaveData ()
		{
			...
			GameController.GameManagers.SaveManager.AddToSaveData(SaveItemKey.BuildingsState, buildingsState);
		}

		public void ApplySave ()
		{
			List<(string, bool, int)> buildingsState = GameController.GameManagers.SaveManager.GetSaveData<List<(string, bool, int)>>(SaveItemKey.BuildingsState);
