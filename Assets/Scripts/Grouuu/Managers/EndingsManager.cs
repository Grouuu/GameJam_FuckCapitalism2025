...
{
	public class EndingsManager : IManager
	{
		private readonly EndingsManagerSettings _settings;
		private EndingData[] _endings;

		public EndingsManager (EndingsManagerSettings settings)
		{
			_settings = settings;
		}
		...
		public void ShowWin (Action onContinue)
		{
			...
			GameController.GameManagers.UiManager.ShowEventPanel(panelData, () => {
		...
		public void UpdateSaveData ()
		{
			...
			GameController.GameManagers.SaveManager.AddToSaveData(SaveItemKey.EndingsUsed, endingsUsed);
		}

		public void ApplySave ()
		{
			List<string> endingsUsed = GameController.GameManagers.SaveManager.GetSaveData<List<string>>(SaveItemKey.DialogsUsed);
